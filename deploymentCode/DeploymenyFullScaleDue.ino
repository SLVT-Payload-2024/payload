...
void setup()
{
  ...
  Serial1.begin(57600);
  Serial1.println("Complete RF Setup");
  ...
  while (!dps.begin_I2C()) {
    Serial1.println("NoAlti");
  }
  dps.configurePressure(DPS310_64HZ, DPS310_64SAMPLES);
  Serial1.println("Complete DPS Initialization");

  //DPS Ground Zero
  Serial1.println("Begin DPS Ground Altitude Setup");
  ...
  Serial1.println("Complete DPS Ground Altitude Setup");
...
void print2RF(String message)
{
  ...
  Serial1.println(String(sysClock) + " " + message);
}
